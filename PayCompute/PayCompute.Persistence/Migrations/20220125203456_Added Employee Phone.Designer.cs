...
namespace PayCompute.Persistence.Migrations
{
    ...
    [Migration("20220125203456_Added Employee Phone")]
    partial class AddedEmployeePhone
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PayCompute.Entities.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PayCompute.Entities.PaymentRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PayCompute.Entities.TaxYear", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PayCompute.Entities.PaymentRecord", b =>
                {
                    b.HasOne("PayCompute.Entities.Employee", "Employee")
                        .WithMany("PaymentRecords")
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PayCompute.Entities.TaxYear", "TaxYear")
                        .WithMany()
